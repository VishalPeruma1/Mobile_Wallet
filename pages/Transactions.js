    ...
    const token = ()=>{
      return(
        ...
        {/* <Text style={{color: '#00000099', fontWeight:'bold', fontSize:14, fontFamily:'Roboto' , marginLeft:5}}>TOKEN</Text> */}
            ...
            <MaterialIcons name="qr-code-scanner" style={{padding:10,fontSize:20, color:"grey"}}/>
            </TouchableOpacity>
        ...
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
         ...
         <TouchableOpacity onPress={()=>setshowQR(false)}>
            ...
            <TextInput placeholder='Comment (Optional)' placeholderTextColor="grey" style={styles.textinput} onChangeText={onChangecom} value={com}  />
              ...
              <TouchableOpacity style={{marginLeft:25 ,backgroundColor:'#1976D2', height:50, width:300 ,marginTop:25, borderRadius:10}}>
                <View style={{flexDirection:'row'}} >
        ...
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
         ...
         <TouchableOpacity onPress={()=>setshowQR(false)}>
          ...
          <TextInput placeholder='Comment (Optional)' placeholderTextColor="grey" style={styles.textinput} onChangeText={onChangecom} value={com}  />
            ...
            <TouchableOpacity style={{marginLeft:25 ,backgroundColor:'#1967D2', height:50, width:300 ,marginTop:25, borderRadius:10}}>
              <View style={{flexDirection:'row'}} >
              <Ionicons name='send-outline' style={{ color:'#fff', fontSize:14,marginLeft:100, marginTop:18}}/>
